      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route exact path="/science" element={<News  key="" pageSize={6} country="us" category="science" />} />
            <Route exact path="/sports" element={<News  key="" pageSize={6} country="us" category="sports" />} />
            <Route exact path="/technology" element={<News  key="" pageSize={6} country="us" category="technology" />} />
          </Routes>
        </Router>
      </div>
    );
